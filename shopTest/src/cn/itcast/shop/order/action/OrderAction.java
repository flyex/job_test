...
public class OrderAction extends ActionSupport implements ModelDriven<Order> {
	...
	public String saveOrder() throws Exception {
		...
		Date date = sft.parse(sft.format(new Date()));
	...
	public String payOrder() throws IOException {
		...
		String p8_Url = "http://192.168.31.161:8080/shop/order_callBack.action"; // 商户接收支付成功数据的地址:
		String p9_SAF = ""; // 送货地址:
		String pa_MP = ""; // 商户扩展信息:
	...
	// 付款成功后跳转回来的路径: 实际操作应该是接受第三方传回来的各个数值，再用工具类进行校验，确认没被修改才是真正支付完成
