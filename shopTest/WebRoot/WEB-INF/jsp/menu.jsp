...
<div class="span10 last">
	<div class="topNav clearfix">
		<ul>
			<s:if test="#session.existUser==null"> <!--index，login，regist里添加struts标签，进行判断处理
														如果session里有user信息则显示登陆的状态-->
			...
			<s:else> <!--如果existUser不等于空-->
			<li id="headerLogin" class="headerLogin" style="display: list-item;">
				<s:property value="#session.existUser.name"/>
				|</li>
			<li id="headerLogin" class="headerLogin" style="display: list-item;"> <!--可能订单太多 进行分页查询-->
