...
public class JsonTest {
    ...
    public void testContain(){
        ...
        String word = "macpro,1";
        String newW = word.replaceAll(",", "-");
...
//
//        System.out.println(device_model+"\t"+os_name+"\t"+language+"\t"+city);
