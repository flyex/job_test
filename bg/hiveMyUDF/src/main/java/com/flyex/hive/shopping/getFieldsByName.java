...
public class getFieldsByName extends UDF {

    public static String evaluate(String line,String field){
        //原数据格式为：14:39:43.358 [main] INFO  com.flyex.AppMain - 1607323183358|{"cm":{"ln":"-113.4","sv":"V2.3.0","os":"8.1.7","g":"7BZE66H5@gmail.com","mid":"m305","nw":"WIFI","l":"pt","vc":"0","hw":"1080*1920","ar":"MX","uid":"u643","t":"1607240453416","la":"11.4","md":"sumsung-19","vn":"1.3.4","ba":"Sumsung","sr":"Z"},"ap":"com.flyex.AppMain","et":[{"ett":"1607273557535","en":"start","kv":{"entry":"2","loading_time":"12","action":"1","open_ad_type":"2","detail":""}}]}
        ...
        String cmFields = "ln,sv,os,g,mid,nw,l,vc,hw,ar,uid,t,la,md,vn,ba,sr";


        if (cmFields.contains(field)){
            return cm.getString(field);
        }else if ("et".equals(field)){
            return et.toJSONString();
        }else if ("st".equals(field)){
            return st;
        }
